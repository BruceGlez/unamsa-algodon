 ...
 * @author bruce
 */
public class seleccionCompraDivisiones extends javax.swing.JFrame {

    /**
     * Creates new form seleccionCliente
     */
    public seleccionCompraDivisiones() {
        initComponents();
    }
    ...
    private void btnSeleccionCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionCompraActionPerformed
       ...
       String subSource = "C:\\Users\\bruce\\Documents\\NetBeansProjects\\unamsa-trabajo\\unamsa-algodon\\src\\main\\java\\interfazModulosReportes\\subReporteDivisiones.jrxml";
       ...
       String sql = "SELECT * FROM divisiones INNER JOIN clientes ON clientes.idclientes = divisiones.fkClienteDivision JOIN compras WHERE noCompra = " + clave;
       JRDesignQuery newQuery = new JRDesignQuery();
       newQuery.setText(sql);
       jd.setQuery(newQuery);
       JasperReport jr = JasperCompileManager.compileReport(jd);
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionCompraDivisiones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionCompraDivisiones().setVisible(true);
            }
        });
    }
